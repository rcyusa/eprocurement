...
import rw.co.snw.config.audit.AuditEventConverter;
import rw.co.snw.domain.PersistentAuditEvent;
...
import static rw.co.snw.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
