...
import rw.co.snw.config.Constants;
import rw.co.snw.domain.Authority;
import rw.co.snw.domain.User;
import rw.co.snw.repository.AuthorityRepository;
import rw.co.snw.repository.UserRepository;
import rw.co.snw.security.AuthoritiesConstants;
import rw.co.snw.service.MailService;
import rw.co.snw.service.UserService;
import rw.co.snw.service.dto.PasswordChangeDTO;
import rw.co.snw.service.dto.UserDTO;
import rw.co.snw.web.rest.errors.ExceptionTranslator;
import rw.co.snw.web.rest.vm.KeyAndPasswordVM;
import rw.co.snw.web.rest.vm.ManagedUserVM;
