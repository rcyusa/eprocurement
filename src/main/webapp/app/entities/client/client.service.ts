...
export class ClientService {
    ...
    public resourceUrl1 = SERVER_API_URL + 'api/clientByTINNumber?clientTINNumber=';
    ...
    clientByTINNumber(tINNumber: String): Observable<EntityResponseType> {
        return this.http.get<any>(this.resourceUrl1 + tINNumber, { observe: 'response' });
    }
